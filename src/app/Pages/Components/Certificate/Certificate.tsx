    ...
    <div data-aos="fade-down" data-aos-delay="700" className="container mx-auto my-5 p-4">
      <div className="flex flex-col md:flex-row justify-center items-center gap-8">
        <div className="md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left px-4">
          <p data-aos="fade-down" data-aos-delay="700" className="animated-text text-4xl sm:text-5xl md:text-6xl italic font-extrabold mb-4 sm:mb-6 md:mb-14">
            Certificate of Achievement
          </p>
          <p data-aos="fade-down" data-aos-delay="700" className="animated-text text-base sm:text-lg md:text-xl font-medium mt-2">
          ...
          <p data-aos="fade-down" data-aos-delay="700" className="animated-text text-lg sm:text-xl md:text-2xl mt-5 font-semibold">
            Best Regards, <br />
            Arun Kumar
          </p>
          <Lottie
