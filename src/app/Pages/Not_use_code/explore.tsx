...
// // const WebData = [
// //   { id: 1, name: 'Web Design', description : "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores eius deserunt quos ratione veniam possimus velit nostrum corrupti rerum harum! Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, commodi." , price : 7000},
// // ]
...
//                     <h1 className='py-4 font-semibold text-2xl lg:text-3xl'>{item.price}</h1>
...
//               </div>
//             </div>
//             <div className='lg:w-[30%] w-full m-5 lg:mt-0 p-5'>
