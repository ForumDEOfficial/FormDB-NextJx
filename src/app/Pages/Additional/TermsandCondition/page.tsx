...
const TermsAndConditions: React.FC = () => {
  return (
    <div className='py-5 px-32'>
      <br />
      <br />
      <h1 className='font-bold text-center p-7' style={{fontSize: 35}}>Terms and Conditions</h1>
      <p>
  For the purpose of these Terms and Conditions, the terms `we`, `us`, `our` used anywhere on this page shall mean GBDRIFT INDIA PRIVATE LIMITED, whose registered/operational office is B.No 958, Sector 21, Pocket C, Gurgaon, HARYANA 122016. `You`, `Your`, `User`, `Visitor` shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.
</p>
<br />
<p>
...
<ul>
  ...
  <li>
    You may not create a link to our website from another website or document without GBDRIFT INDIA PRIVATE LIMITED’s prior written consent.
  </li><br />
  <li>
